...
## External code
There are 4 external models used for the paper, GMKRR, CANDyMAN, LDNet and NODE. They are used for learning Kuramoto-Sivashinsky travelling dynamics, and the codes are located in the directory named external.  The Python environment used for each model can be generated by the .yml files in envs directory.

GMKRR: Please contact the author for the source code
CANDyMAN repo: https://github.com/dfloryan/neural-manifold-dynamics